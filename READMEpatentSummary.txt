...
READMEpatentSummary.py is a program written in python that takes input arguments and gives output Summary of every Chapter.

Running program from Command Prompt (windows)

Step 1 : Go into PDF_Summary folder where you will find “patentSummary.py” python file.

Step 2 : run command 

Example :
 C:\Users\AMITABH\Desktop\PDF_Summary>patentSummary.py 

Step 3 : Input Arguments :
1 Source PDF file with path 
	Example : C:\Users\AMITABH\Desktop\PDF_Summary\pdf\patent.pdf 
